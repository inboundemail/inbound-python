...
class TestEmails:
    ...
    def test_raw_response_create(self, client: Inbound) -> None:
        response = client.v2.emails.with_raw_response.create(
            from_="from",
            subject="subject",
            to="to",
        )
    ...
    def test_streaming_response_create(self, client: Inbound) -> None:
        with client.v2.emails.with_streaming_response.create(
            from_="from",
            subject="subject",
            to="to",
        ) as response:
...
class TestAsyncEmails:
    ...
    async def test_method_create(self, async_client: AsyncInbound) -> None:
        email = await async_client.v2.emails.create(
            from_="from",
            subject="subject",
            to="to",
        )
    ...
    async def test_raw_response_create(self, async_client: AsyncInbound) -> None:
        response = await async_client.v2.emails.with_raw_response.create(
            from_="from",
            subject="subject",
            to="to",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncInbound) -> None:
        async with async_client.v2.emails.with_streaming_response.create(
            from_="from",
            subject="subject",
            to="to",
        ) as response:
