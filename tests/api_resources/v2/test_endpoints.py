...
class TestEndpoints:
    ...
    def test_method_create(self, client: Inbound) -> None:
        endpoint = client.v2.endpoints.create(
            config="config",
            name="name",
            type="webhook",
        )
    ...
    def test_raw_response_create(self, client: Inbound) -> None:
        response = client.v2.endpoints.with_raw_response.create(
            config="config",
            name="name",
            type="webhook",
        )
    ...
    def test_streaming_response_create(self, client: Inbound) -> None:
        with client.v2.endpoints.with_streaming_response.create(
            config="config",
            name="name",
            type="webhook",
        ) as response:
    ...
    def test_method_retrieve(self, client: Inbound) -> None:
        endpoint = client.v2.endpoints.retrieve(
            path_id="id",
            query_id="id",
        )
    ...
    def test_raw_response_retrieve(self, client: Inbound) -> None:
        response = client.v2.endpoints.with_raw_response.retrieve(
            path_id="id",
            query_id="id",
        )
    ...
    def test_streaming_response_retrieve(self, client: Inbound) -> None:
        with client.v2.endpoints.with_streaming_response.retrieve(
            path_id="id",
            query_id="id",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_retrieve(self, client: Inbound) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `path_id` but received ''"):
            client.v2.endpoints.with_raw_response.retrieve(
                path_id="",
                query_id="id",
            )
    ...
    def test_method_update(self, client: Inbound) -> None:
        endpoint = client.v2.endpoints.update(
            path_id="id",
            body_id="id",
        )
    ...
    def test_raw_response_update(self, client: Inbound) -> None:
        response = client.v2.endpoints.with_raw_response.update(
            path_id="id",
            body_id="id",
        )
    ...
    def test_streaming_response_update(self, client: Inbound) -> None:
        with client.v2.endpoints.with_streaming_response.update(
            path_id="id",
            body_id="id",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_update(self, client: Inbound) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `path_id` but received ''"):
            client.v2.endpoints.with_raw_response.update(
                path_id="",
                body_id="id",
            )
    ...
    def test_method_list(self, client: Inbound) -> None:
        endpoint = client.v2.endpoints.list()
    ...
    def test_raw_response_list(self, client: Inbound) -> None:
        response = client.v2.endpoints.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Inbound) -> None:
        with client.v2.endpoints.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_delete(self, client: Inbound) -> None:
        endpoint = client.v2.endpoints.delete(
            "id",
        )
    ...
    def test_raw_response_delete(self, client: Inbound) -> None:
        response = client.v2.endpoints.with_raw_response.delete(
            "id",
        )
    ...
    def test_streaming_response_delete(self, client: Inbound) -> None:
        with client.v2.endpoints.with_streaming_response.delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: Inbound) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.v2.endpoints.with_raw_response.delete(
                "",
            )
    ...
    def test_method_test(self, client: Inbound) -> None:
        endpoint = client.v2.endpoints.test(
            path_id="id",
            body_id="id",
        )
    ...
    def test_raw_response_test(self, client: Inbound) -> None:
        response = client.v2.endpoints.with_raw_response.test(
            path_id="id",
            body_id="id",
        )
    ...
    def test_streaming_response_test(self, client: Inbound) -> None:
        with client.v2.endpoints.with_streaming_response.test(
            path_id="id",
            body_id="id",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_test(self, client: Inbound) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `path_id` but received ''"):
            client.v2.endpoints.with_raw_response.test(
                path_id="",
                body_id="id",
            )
...
class TestAsyncEndpoints:
    ...
    async def test_method_create(self, async_client: AsyncInbound) -> None:
        endpoint = await async_client.v2.endpoints.create(
            config="config",
            name="name",
            type="webhook",
        )
    ...
    async def test_raw_response_create(self, async_client: AsyncInbound) -> None:
        response = await async_client.v2.endpoints.with_raw_response.create(
            config="config",
            name="name",
            type="webhook",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncInbound) -> None:
        async with async_client.v2.endpoints.with_streaming_response.create(
            config="config",
            name="name",
            type="webhook",
        ) as response:
    ...
    async def test_method_retrieve(self, async_client: AsyncInbound) -> None:
        endpoint = await async_client.v2.endpoints.retrieve(
            path_id="id",
            query_id="id",
        )
        assert_matches_type(EndpointRetrieveResponse, endpoint, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncInbound) -> None:
        response = await async_client.v2.endpoints.with_raw_response.retrieve(
            path_id="id",
            query_id="id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncInbound) -> None:
        async with async_client.v2.endpoints.with_streaming_response.retrieve(
            path_id="id",
            query_id="id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncInbound) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `path_id` but received ''"):
            await async_client.v2.endpoints.with_raw_response.retrieve(
                path_id="",
                query_id="id",
            )
    ...
    async def test_method_update(self, async_client: AsyncInbound) -> None:
        endpoint = await async_client.v2.endpoints.update(
            path_id="id",
            body_id="id",
        )
        assert_matches_type(EndpointUpdateResponse, endpoint, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncInbound) -> None:
        response = await async_client.v2.endpoints.with_raw_response.update(
            path_id="id",
            body_id="id",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncInbound) -> None:
        async with async_client.v2.endpoints.with_streaming_response.update(
            path_id="id",
            body_id="id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_update(self, async_client: AsyncInbound) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `path_id` but received ''"):
            await async_client.v2.endpoints.with_raw_response.update(
                path_id="",
                body_id="id",
            )
    ...
    async def test_method_list(self, async_client: AsyncInbound) -> None:
        endpoint = await async_client.v2.endpoints.list()
        assert_matches_type(EndpointListResponse, endpoint, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncInbound) -> None:
        response = await async_client.v2.endpoints.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncInbound) -> None:
        async with async_client.v2.endpoints.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncInbound) -> None:
        endpoint = await async_client.v2.endpoints.delete(
            "id",
        )
        assert_matches_type(EndpointDeleteResponse, endpoint, path=["response"])
    ...
    async def test_raw_response_delete(self, async_client: AsyncInbound) -> None:
        response = await async_client.v2.endpoints.with_raw_response.delete(
            "id",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncInbound) -> None:
        async with async_client.v2.endpoints.with_streaming_response.delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncInbound) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.v2.endpoints.with_raw_response.delete(
                "",
            )
    ...
    async def test_method_test(self, async_client: AsyncInbound) -> None:
        endpoint = await async_client.v2.endpoints.test(
            path_id="id",
            body_id="id",
        )
        assert_matches_type(EndpointTestResponse, endpoint, path=["response"])
    ...
    async def test_raw_response_test(self, async_client: AsyncInbound) -> None:
        response = await async_client.v2.endpoints.with_raw_response.test(
            path_id="id",
            body_id="id",
        )
    ...
    async def test_streaming_response_test(self, async_client: AsyncInbound) -> None:
        async with async_client.v2.endpoints.with_streaming_response.test(
            path_id="id",
            body_id="id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_test(self, async_client: AsyncInbound) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `path_id` but received ''"):
            await async_client.v2.endpoints.with_raw_response.test(
                path_id="",
                body_id="id",
            )
