...
def _get_open_connections(client: Inbound | AsyncInbound) -> int:
...
class TestInbound:
    ...
    def test_client_timeout_option(self) -> None:
        client = Inbound(base_url=base_url, api_key=api_key, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_multipart_repeating_array(self, client: Inbound) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = Inbound(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    @pytest.mark.parametrize(
        "client",
        [
            Inbound(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            Inbound(
    ...
    def test_base_url_trailing_slash(self, client: Inbound) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Inbound) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Inbound) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Inbound(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Inbound(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Inbound(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Inbound) -> None:
        ...
        with pytest.raises(APITimeoutError):
            client.v2.domains.with_streaming_response.list().__enter__()
    ...
    def test_omit_retry_count_header(
        ...
        response = client.v2.domains.with_raw_response.list(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.v2.domains.with_raw_response.list(extra_headers={"x-stainless-retry-count": "42"})
...
class TestAsyncInbound:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncInbound) -> None:
    ...
    def test_base_url_trailing_slash(self, client: AsyncInbound) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncInbound) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncInbound) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncInbound(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncInbound(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        ...
        with pytest.raises(APITimeoutError):
            await async_client.v2.domains.with_streaming_response.list().__aenter__()
    ...
    async def test_retries_taken(
        ...
        response = await client.v2.domains.with_raw_response.list()
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncInbound, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.v2.domains.with_raw_response.list(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.v2.domains.with_raw_response.list(extra_headers={"x-stainless-retry-count": "42"})
