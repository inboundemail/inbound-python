...
- <code title="post /api/v2/emails/{id}/resend">client.v2.emails.<a href="./src/inbound/resources/v2/emails/emails.py">resend</a>(id, \*\*<a href="src/inbound/types/v2/email_resend_params.py">params</a>) -> <a href="./src/inbound/types/v2/email_resend_response.py">EmailResendResponse</a></code>
- <code title="post /api/v2/emails/{id}/retry-delivery">client.v2.emails.<a href="./src/inbound/resources/v2/emails/emails.py">retry_delivery</a>(id, \*\*<a href="src/inbound/types/v2/email_retry_delivery_params.py">params</a>) -> <a href="./src/inbound/types/v2/email_retry_delivery_response.py">EmailRetryDeliveryResponse</a></code>
- <code title="post /api/v2/emails">client.v2.emails.<a href="./src/inbound/resources/v2/emails/emails.py">send</a>(\*\*<a href="src/inbound/types/v2/email_send_params.py">params</a>) -> <a href="./src/inbound/types/v2/email_send_response.py">EmailSendResponse</a></code>
...
- <code title="delete /api/v2/emails/schedule/{id}">client.v2.emails.schedule.<a href="./src/inbound/resources/v2/emails/schedule.py">cancel</a>(id) -> <a href="./src/inbound/types/v2/emails/schedule_cancel_response.py">ScheduleCancelResponse</a></code>
