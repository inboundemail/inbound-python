...
__all__ = ["ScheduleCreateParams", "Tag"]
...
class ScheduleCreateParams(TypedDict, total=False):
    ...
    Supports "email@domain.com" and "Display Name <email@domain.com>" formats. Must
    be from verified domain or agent@inbnd.dev
    """

    scheduled_at: Required[str]
    """When to send email.

    ISO 8601 format or natural language ("in 1 hour", "tomorrow at 9am")
    """
    ...
    timezone: str
    """User timezone for natural language parsing"""
