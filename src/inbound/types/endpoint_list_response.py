...
__all__ = ["EndpointListResponse", "Data", "DataDeliveryStats", "Pagination"]


class DataDeliveryStats(BaseModel):
...
class Data(BaseModel):
    ...
    delivery_stats: Optional[DataDeliveryStats] = FieldInfo(alias="deliveryStats", default=None)
