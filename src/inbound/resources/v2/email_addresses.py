...
from ...types.v2 import email_address_list_params, email_address_create_params, email_address_update_params
...
from ...types.v2.email_address_list_response import EmailAddressListResponse
from ...types.v2.email_address_create_response import EmailAddressCreateResponse
from ...types.v2.email_address_delete_response import EmailAddressDeleteResponse
from ...types.v2.email_address_update_response import EmailAddressUpdateResponse
from ...types.v2.email_address_retrieve_response import EmailAddressRetrieveResponse
